...
<section class="am-works"> 
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty(pagesetting('student_btn_txt')) || !empty(pagesetting('student_btn_url')) || !empty(pagesetting('tutor_btn_url')) || !empty(pagesetting('tutor_btn_txt'))): ?>
        <div class="am-joincommunity_btn">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty(pagesetting('student_btn_txt')) || !empty(pagesetting('student_btn_url'))): ?>
            ...
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty(pagesetting('tutor_btn_url')) || !empty(pagesetting('tutor_btn_txt'))): ?>
...
<?php /**PATH C:\Users\User\Desktop\well-known\resources\views/pagebuilder/content-banner/view.blade.php ENDPATH**/ ?>