...
<?php endif; ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if($showCart): ?>
                                ...
                                <template x-for="(item, index) in cartData">
                                    <li>
                                        <div class="am-ordersummary_list_title">
                                            ...
                                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                            <!--[if BLOCK]><![endif]--><?php if(\Nwidart\Modules\Facades\Module::has('CourseBundles') && \Nwidart\Modules\Facades\Module::isEnabled('CourseBundles')): ?>
        ...
        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
    <!--[if BLOCK]><![endif]--><?php if($userRole == 'tutor' || $userRole == 'student'): ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-130302479-0', $__slots ?? [], get_defined_vars());
...
?>
    ...
    <div class="am-header_user_menu">
        ...
        <div class="am-usermenu-dropdown <?php echo e($userRole == 'admin' ? 'am-dropdown_admin' : ''); ?>">
            ...
            <!--[if BLOCK]><![endif]--><?php if(setting('_lernen.allow_role_switching') == 'yes'): ?>
            ...
            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
            <ul>
                <!--[if BLOCK]><![endif]--><?php if($userRole == 'student'): ?>
                    <li>
                ...
                <!--[if BLOCK]><![endif]--><?php if($userRole == 'tutor' || $userRole == 'student'): ?>
                    ...
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                <!--[if BLOCK]><![endif]--><?php if($userRole == 'admin'): ?>
                    <li>
...
</script><?php /**PATH /home/clientagaintheme/lla.client.againtheme.com/resources/views/components/frontend/user-menu.blade.php ENDPATH**/ ?>