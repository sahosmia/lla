<div wire:init="loadData">
    <div class="cr-course-box">
        <div class="cr-content-box">
            <h2><?php echo e(__('courses::courses.course_content')); ?></h2>
            <p><?php echo e(__('courses::courses.organize_sections')); ?></p>
        </div>
        <div class="cr-course-body">
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div wire:key="section-<?php echo e($section->id); ?>" id="section-<?php echo e($section->id); ?>" class="cr-faq-accordion">
                    <div class="cr-formarea accordion">
                        <div class="accordion-item">
                            <input type="radio" name="accordion" id="<?php echo e('accordion-item-' . $section->id); ?>"
                                class="accordion-checkbox">
                            <label for="<?php echo e('accordion-item-' . $section->id); ?>" class="cr-course-item accordion-header">
                                ...
                                <div class="am-itemdropdown">
                                    ...
                                    <ul class="am-itemdropdown_list dropdown-menu" aria-labelledby="dropdownMenuLink">
                                        <li wire:click="editSectionFunction(<?php echo e($section); ?>)">
                                        ...
                                        <li>
                                            <a href="javascript:void(0);" class="cr-delete-curriculum" data-id="<?php echo e($section->id); ?>" data-component_id="window.Livewire.find('<?php echo e($_instance->getId()); ?>')">
                                                <i>
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="20"
                                                        height="20" viewBox="0 0 20 20" fill="none">
                                                        <path
...
[$__name, $__params] = $__split('courses::manage-course-content.components.curriculum', ['id' => $section->id,'section' => $section]);

$__html = app('livewire')->mount($__name, $__params, now() . $section->id . 'curriculum', $__slots ?? [], get_defined_vars());
...
?>
            ...
            <!--[if BLOCK]><![endif]--><?php if($addSection): ?>
                <div class="cr-formarea">
                    <div class="form-group">
                        <label class="am-important"
                            for="section-title"><?php echo e(__('courses::courses.section_title')); ?></label>
                        <input wire:model="title" class="form-control <?php $__errorArgs = ['title'];
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            placeholder="<?php echo e(__('courses::courses.enter_course_title')); ?>">
...
unset($__errorArgs, $__bag); ?>">
                        ...
                        <div wire:ignore class="am-custom-editor am-custom-textarea">
                            <textarea class="form-control cr-summernote" id="section-desc" data-id="window.Livewire.find('<?php echo e($_instance->getId()); ?>')" data-model_id="description"
                                placeholder="<?php echo e(__('courses::courses.enter_description')); ?>"></textarea>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div class="cr-btns">
                        <button wire:click="addSectionState(false)" wire:loading.class="am-btn_disable" wire:target="addSectionState(false)" class="am-cancel-btn"><?php echo e(__('courses::courses.cancel')); ?></button>
                        <button wire:click="createSection" type="submit" class="am-btn">
                            <span wire:loading wire:target="createSection"><?php echo e(__('courses::courses.loading')); ?></span>
                            <span wire:loading.remove wire:target="createSection"><?php echo e(__('courses::courses.add_section')); ?></span>
                        </button>
                    </div>
                </div>
            <?php else: ?>
                <button wire:click="addSectionState(true)" class="cr-addbtn" wire:loading.attr="disabled" wire:target="addSectionState(true)" wire:loading.class="am-btn_disable">
                    ...
                    <?php echo e(__('courses::courses.create_section')); ?>

                    <i class="am-icon-plus-02" wire:loading.remove wire:target="addSectionState(true)"></i>
                </button>
            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
        </div>
        <?php echo e($sections->links('courses::pagination.pagination')); ?>


        <div class="am-themeform_footer">
            <a href="<?php echo e(route('courses.tutor.edit-course', ['tab' =>  (isPaidSystem() ? 'pricing' : 'media'), 'id' => $course->id])); ?>">
            ...
            <button wire:click="save" type="button" class="am-btn" wire:loading.remove
                wire:target="save"><?php echo e(__('courses::courses.save_continue')); ?></button>
            <button class="am-btn am-btn_disable" wire:loading.flex
                wire:target="save"><?php echo e(__('courses::courses.save_continue')); ?>
        ...
        <div class="modal-dialog modal-dialog-centered ">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="edit-contentlabel"><?php echo e(__('courses::courses.edit_course_section')); ?></h5>
                ...
                <div class="modal-body">
                    <form class="am-themeform">
                        <fieldset>
                            <div class="form-group">
                                <label class="am-important"
                                    for="course-title"><?php echo e(__('courses::courses.title')); ?></label>
...
unset($__errorArgs, $__bag); ?>">
                                <div wire:ignore class="am-editor-wrapper">
                                    <div class="am-custom-editor am-custom-textarea">
                                        <textarea id="edit_section_description" data-id="window.Livewire.find('<?php echo e($_instance->getId()); ?>')" data-model_id="description" class="form-control cr-summernote" placeholder="<?php echo e(__('courses::courses.enter_answer')); ?>"></textarea>
                                        <span class="characters-count"></span>
                                    </div>
                                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="am-btn" wire:click="updateSection" wire:loading.attr="disabled">
                        <span wire:loading.remove
                            wire:target="updateSection"><?php echo e(__('courses::courses.save_changes')); ?></span>
                        <span wire:loading wire:target="updateSection"><?php echo e(__('courses::courses.saving')); ?></span>
                    </button>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="cr-delete-content">
                        ...
                        <p><?php echo e(__('courses::courses.confirm_delete')); ?></p>
                    </div>
                </div>
                <div class="modal-footer">
                    ...
                    <button type="button" class="am-btn cr-del-btn cr-delete-action">
                        <span><?php echo e(__('courses::courses.yes')); ?></span>
                    </button>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        document.addEventListener('DOMContentLoaded', (event) => {
            ...
            jQuery(document).on('click', '.cr-delete-action', async function() {
                ...
                _this.find('span').text('<?php echo e(__('courses::courses.deleting')); ?>');
                await component.deleteRecord(id);
                _this.removeAttr('disabled');
                _this.removeClass('am-btn_disable');
                _this.find('span').text('<?php echo e(__('courses::courses.yes')); ?>');
...
<?php $__env->stopPush(); ?><?php /**PATH /home/clientagaintheme/lla.client.againtheme.com/Modules/Courses/resources/views/livewire/tutor/course-creation/components/manage-course-content/course-content.blade.php ENDPATH**/ ?>