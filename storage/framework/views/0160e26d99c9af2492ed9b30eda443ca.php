...
<?php endif; ?>
                        ...
                        <!--[if BLOCK]><![endif]--><?php if(isDemoSite()): ?>
                            <div class="form-group">
                                ...
                                <div class="am-login-options">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if(setting('_lernen.allow_register') !== 'no'): ?>
        ...
        <!--[if BLOCK]><![endif]--><?php if(isGoogleSociaLoginEnabled() && setting('_lernen.allow_register') !== 'no' ): ?>    
...
<?php $__env->stopPush(); ?><?php /**PATH /home/clientagaintheme/lla.client.againtheme.com/resources/views/livewire/pages/auth/login.blade.php ENDPATH**/ ?>