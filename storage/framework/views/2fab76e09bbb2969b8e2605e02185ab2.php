<main class="tb-main tb-blogwrap" wire:init="loadData">
    <div class="row">
        <?php echo $__env->make('courses::livewire.admin.categories.update', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <div class="col-lg-8 col-md-12 tb-md-60">
            <div class="tb-dhb-mainheading">
                <h4><?php echo e(__('courses::courses.text')); ?></h4>
                <div class="tb-sortby">
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/clientagaintheme/lla.client.againtheme.com/Modules/Courses/resources/views/livewire/admin/categories/categories.blade.php ENDPATH**/ ?>