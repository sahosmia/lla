            ...
            <div class="accordion op-accordion" id="<?php echo e($id ?? ''); ?>">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if( !empty($value) && is_array($value) ): ?>
                    <?php
                        $title_index = 1;
                    ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $value; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=> $single): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        <div class="op-accordion-item">
                            ...
                            <div id="op-rep-accord-<?php echo e($index); ?>" class="accordion-collapse collapse" data-bs-parent="#<?php echo e($id ?? ''); ?>">
                                <div class="accordion-body">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if( !empty($mapping_fields) && is_array($mapping_fields) ): ?>
                                        <?php
                ...
                <?php else: ?>
                    <div class="op-accordion-item">
                        ...
                        <div id="op-rep-accord-0" class="accordion-collapse collapse" data-bs-parent="#<?php echo e($id ?? ''); ?>">
                            <div class="accordion-body">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if( !empty($fields) && is_array($fields) ): ?>
...
<?php /**PATH C:\Users\User\Desktop\well-known\vendor\larabuild\optionbuilder\src/../resources/views/components/multiple-repeater.blade.php ENDPATH**/ ?>