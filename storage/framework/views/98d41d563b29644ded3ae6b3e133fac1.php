...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1502826936-0', $__key);
                ...
                <?php echo e(Breadcrumbs::render()); ?>
                    ...
                    <div class="tb-dropdoenwrap">
                        <div class="tb-logowrapper tb-icontoggler">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($info) ): ?>
                                <div class="tb-adminheadwrap">
                                    <strong class="tb-adminhead__img" id="adminImage">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($info->profile?->image) && Storage::disk(getStorageDisk())->exists($info->profile?->image)): ?>
                        ...
                        <div class="tb-db-dashboard_box_wrap">
                            <div class="tb-db-dashboard_box_wrap_inner">
                                <div class="tb-menumanagement_wrap">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($slot)): ?>
                                    <?php echo e($slot); ?>
...
<?php /**PATH C:\Users\User\Desktop\well-known\resources\views/layouts/admin-app.blade.php ENDPATH**/ ?>