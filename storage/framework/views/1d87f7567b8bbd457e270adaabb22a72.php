        ...
        <div class="tab-content pb-tabs-holder">
            <div class="pb-blocks-tab tab-pane fade show active" id="blocks-tab">
                <div id="pb-advanceaccordion" class="pb-collapse-wrapper">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $componentTabs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tab => $elements): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="op-accordion-item">
                            ...
                            <div id="<?php echo e(\Illuminate\Support\Str::slug($tab)); ?>-accord" class="accordion-collapse collapse"
                                ...
                                <ul class="pb-elementcontent-wrapper" id="draggable-<?php echo e(\Illuminate\Support\Str::slug($tab)); ?>">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($elements)): ?>
...
<!-- asidebar --><?php /**PATH C:\Users\User\Desktop\well-known\vendor\larabuild\pagebuilder\src/../resources/views/components/sidebar.blade.php ENDPATH**/ ?>