<div>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($slider == false): ?>
        <ul class="am-experience-tutor-list">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $experiencedTutors->take($selectTutor); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $singleTutor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li data-aos="fade-up" data-aos-easing="ease" data-aos-delay="<?php echo e($loop->iteration * 200); ?>">
                <div class="am-experience-tutor-card">
                    <div class="am-experience-tutor-img">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sectionVerient == 'am-tutors-varient-two'): ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($singleTutor->profile->image): ?>
                        ...
                        <?php else: ?>
                            ...
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::check() && Auth()->user()->role == 'student'): ?>
                        ...
                        <div class="am-experience-tutor-info"> 
                            <div class="am-experience-tutor-name">
                                <div class="am-tutorsearch_user_name">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($singleTutor->profile->tagline): ?>
                            ...
                            <div class="am-experience-tutor-name">
                                <div class="am-tutorsearch_user_name">
                                    <h3>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($singleTutor->profile->verified_at): ?>
...
<?php endif; ?>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($singleTutor->address?->country?->short_code)): ?>
...
<?php if (! $__env->hasRenderedOnce('9109b595-bf87-414f-9a04-f2b978ecbd9f')): $__env->markAsRenderedOnce('9109b595-bf87-414f-9a04-f2b978ecbd9f');
...
<?php /**PATH C:\Users\User\Desktop\well-known\resources\views/livewire/experienced-tutors.blade.php ENDPATH**/ ?>