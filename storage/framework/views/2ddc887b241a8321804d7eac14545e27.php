                        ...
                        <div class="pb-layout-input">
                            <div class="op-textcontent">
                                <ul class="op-upload-img" id="background_image">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if( !empty($styles['image'][0]) ): ?>
                                    <?php
...
</script><?php /**PATH C:\Users\User\Desktop\well-known\vendor\larabuild\pagebuilder\src/../resources/views/components/styles.blade.php ENDPATH**/ ?>