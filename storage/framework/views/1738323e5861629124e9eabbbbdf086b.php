<div class="cr-course-creation">
    <h2><?php echo e(__('courses::courses.sourses_tep', ['current' => $currentTabNumber + 1, 'total' => count($tabs)])); ?></h2>
    <p><?php echo e(__('courses::courses.step_description')); ?></p>

    <ul class="cr-steps">
        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $tabs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tab => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li 
            class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                'cr-active' => $tab === $activeTab,
                'cr-completed' => $currentTabNumber >= $value['step']
            ]); ?>"
            <?php if($currentTabNumber >= $value['step']): ?> wire:click="navigateToRoute('<?php echo e($tab); ?>')" <?php endif; ?>
            >
                <span class="cr-icon">
                ...
                <div class="cr-steps_info">
                    <strong><?php echo e($value['title']); ?>

                        <!--[if BLOCK]><![endif]--><?php if($value['required']): ?>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($tab === 'details'): ?>
                        <span class="cr-description"><?php echo e(__('courses::courses.basic_details_info')); ?></span>
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                    <em>
                        <?php echo e(__('courses::courses.edit_again')); ?>
...
<?php /**PATH /home/clientagaintheme/lla.client.againtheme.com/Modules/Courses/resources/views/livewire/tutor/course-creation/components/course-sidebar.blade.php ENDPATH**/ ?>