<div class="cr-all-courses" wire:init="loadData">
        ...
        <div class="cr-filters">
            ...
            <div class="at-form-group" wire:ignore>
                <select class="am-select2"  data-componentid="window.Livewire.find('<?php echo e($_instance->getId()); ?>')" id="status-select" data-live="true" data-searchable="false" data-wiremodel="filters.status">
                    ...
                    <!--[if BLOCK]><![endif]--><?php if(!empty($statuses)): ?>
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status => $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="am-table-area">
            ...
            <table class="am-table">
                ...
                <!--[if BLOCK]><![endif]--><?php if(!$isLoading): ?>
                    ...
                    <tbody wire:loading.remove.block>
                        <!--[if BLOCK]><![endif]--><?php if(!empty($courses) && $courses->isNotEmpty()): ?>
                                ...
                                <tr wire:key="<?php echo e($course->id); ?>">
                                    <td data-label="<?php echo e(__('courses::courses.course_title')); ?>">
                                        <div class="cr-image-and-text">
                                            <figure>
                                                <!--[if BLOCK]><![endif]--><?php if(!empty($course->thumbnail?->path)): ?>
                                    ...
                                    <td data-label="<?php echo e(__('courses::courses.enrolled_students')); ?>">
                                        <div class="student-list">
                                            <!--[if BLOCK]><![endif]--><?php if(!empty($course->enrollments) && $course->enrollments->isNotEmpty()): ?>
                                                <div class="cr-avatar-group">
                                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $course->enrollments->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enrollment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <!--[if BLOCK]><![endif]--><?php if(!empty($enrollment->student?->image) && Storage::disk(getStorageDisk())->exists($enrollment->student?->image)): ?>
                                                ...
                                                <span>
                                                    <!--[if BLOCK]><![endif]--><?php if($course->enrollments_count == 1): ?>
                                        ...
                                        <div class="cr-status-wrap">
                                            ...
                                            <div class="am-itemdropdown">
                                                ...
                                                <ul class="am-itemdropdown_list dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                    ...
                                                    <li> 
                                                        <!--[if BLOCK]><![endif]--><?php if( $course->featured): ?>
        ...
        <!--[if BLOCK]><![endif]--><?php if(!$isLoading && $courses->links()->paginator->hasPages()): ?>
                    ...
                    <div class="am-pagination-filter" wire:ignore>
                        ...
                        <span class="am-select">
                            <select x-init="$wire.dispatch('initSelect2', {target: '#per-page-select'});" class="am-select2" id="per-page-select" data-componentid="window.Livewire.find('<?php echo e($_instance->getId()); ?>')" data-live="true" data-searchable="false" data-wiremodel="perPage">
                                <!--[if BLOCK]><![endif]--><?php if(!empty($perPage) && !in_array($this->perPage, $this->parPageList)): ?>
                                    <option value="<?php echo e($perPage); ?>"><?php echo e($perPage); ?></option>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = perPageOpt(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<script defer src="<?php echo e(asset('modules/courses/js/nouislider.min.js')); ?>"></script>
 ...
 <?php $__env->stopPush(); ?>
<?php /**PATH /home/clientagaintheme/lla.client.againtheme.com/Modules/Courses/resources/views/livewire/tutor/course-listing/course-listing.blade.php ENDPATH**/ ?>