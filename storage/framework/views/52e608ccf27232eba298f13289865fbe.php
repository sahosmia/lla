...
<!--[if BLOCK]><![endif]--><?php if($paginator->hasPages()): ?>
    <div class='uc-pagination'>
        <ul>
            ...
            <?php else: ?>
                <li class="uc-nextpage uc-disabled">
...
<?php /**PATH /home/clientagaintheme/lla.client.againtheme.com/Modules/Upcertify/resources/views/pagination/pagination.blade.php ENDPATH**/ ?>