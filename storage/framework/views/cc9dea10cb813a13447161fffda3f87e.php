...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if( config('pagebuilder.add_jquery') === 'no' ): ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make(config('pagebuilder.site_layout'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Desktop\well-known\vendor\larabuild\pagebuilder\src/../resources/views/pagebuilder-iframe.blade.php ENDPATH**/ ?>