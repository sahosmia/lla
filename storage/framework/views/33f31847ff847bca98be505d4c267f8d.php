<div class="col-lg-4 col-md-12 tb-md-40">
    <div class="tb-dbholder tb-packege-setting">
        <div class="tb-dbbox tb-dbboxtitle">
            <h5><?php echo e($edit_id ? __('notification_template.update_notification') : __('notification_template.add_notification')); ?></h5>
        </div>
        <div class="tb-dbbox">
                        ...
                        <div class="form-group">
                            <!--[if BLOCK]><![endif]--><?php if( !$edit_id ): ?>
                                <div class="tb-actionselect">
                                    <span><?php echo e(__('notification_template.select_notification')); ?>: </span>
                                </div>
                                <div class="tb-select border-0">
                                    <select class="am-select2" data-componentid="window.Livewire.find('<?php echo e($_instance->getId()); ?>')" data-live="true" data-searchable="false" data-wiremodel="template_key" id="template_key" class="form-control">
                                        <option value=""><?php echo e(__('notification_template.select_notification')); ?></option>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                           ...
                           <div class="form-group">
                            ...
                            <div class="tb-email-status">
                                <span><?php echo e(__('notification_template.set_notification_status')); ?></span>
                        ...
                        <div class="form-group tb-dbtnarea">
                            <a href="javascript:void(0);" wire:click.prevent="saveEmailTemplate" class="tb-btn">
                                <?php echo e($edit_id ?  __('notification_template.update_notification') : __('notification_template.add_notification')); ?>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/clientagaintheme/lla.client.againtheme.com/resources/views/livewire/pages/admin/notification-templates/update.blade.php ENDPATH**/ ?>