<div class="am-quiz-detail">
    <div class="am-quiz-detail_box">
        <!--[if BLOCK]><![endif]--><?php if(!empty(setting('_quiz.quiz_start_text')) || !empty(setting('_quiz.quiz_start_banner'))): ?>
        <?php
        ...
        ?>
            <div class="am-quiz-detail_banner" style="background: url('<?php echo e($bgImage); ?>')">
                <figure>
...
<?php endif; ?>
                ...
                <?php if(!empty(setting('_quiz.quiz_start_text'))): ?>
                    <h3><?php echo e(setting('_quiz.quiz_start_text')); ?></h3>
                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
            </div>
        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
        <div class="am-quiz-detail_content">
            <div class="am-quiz-detail_info">
                <!--[if BLOCK]><![endif]--><?php if(!empty($quizAttempt?->quiz?->tutor?->profile?->image) && Storage::disk(getStorageDisk())->exists($quizAttempt?->quiz?->tutor?->profile?->image)): ?>
                    <figure>
                        <img src="<?php echo e(resizedImage($quizAttempt?->quiz?->tutor?->profile?->image, 160, 160)); ?>" alt="<?php echo e($quizAttempt?->quiz?->tutor?->profile?->full_name); ?>" />
                    </figure>
                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                <h6>
                    <?php echo e($quizAttempt?->quiz?->tutor?->profile?->full_name); ?>

                    <span><?php echo e(__('quiz::quiz.quiz_author')); ?></span>
                </h6>
            </div>
            <div class="am-quiz-detail_description">
                ...
                <div class="am-course-stats">
                    <div class="am-stat-item">
                        ...
                        <div class="am-stat-content">
                            <span class="am-stat-label"><?php echo e(__('quiz::quiz.total_questions')); ?></span>
                            <span class="am-stat-value"><?php echo e($quizAttempt?->total_questions); ?></span>
                        </div>
                    </div>
                    <div class="am-stat-item">
                        <div class="am-stat-icon-wrapper">
                        ...
                        <div class="am-stat-content">
                            <span class="am-stat-label"><?php echo e(__('quiz::quiz.total_marks')); ?></span>
                            <span class="am-stat-value"><?php echo e($quizAttempt?->total_marks); ?></span>
                        </div>
                    </div>
                    <div class="am-stat-item">
                        <div class="am-stat-icon-wrapper">
                        ...
                        <!--[if BLOCK]><![endif]--><?php if(!empty($quizAttempt?->quiz?->settings?->where('meta_key', 'passing_grade')->first()->meta_value)): ?>
                            <div class="am-stat-content">
                                <span class="am-stat-label"><?php echo e(__('quiz::quiz.passing_marks')); ?></span>
                                <span class="am-stat-value"><?php echo e($quizAttempt?->quiz?->settings?->where('meta_key', 'passing_grade')->first()->meta_value); ?>%</span>
                            </div>
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                    </div>
                    <!--[if BLOCK]><![endif]--><?php if(!empty($quizAttempt?->quiz?->settings?->where('meta_key', 'duration')->first()->meta_value)): ?>
                    <div class="am-stat-item">
                        <div class="am-stat-icon-wrapper">
                            <i class="am-icon-time"></i>
                        </div>
                        <div class="am-stat-content">
                            <span class="am-stat-label"><?php echo e(__('quiz::quiz.duration')); ?></span>
                            <span class="am-stat-value"><?php echo e($quizAttempt?->quiz?->settings?->where('meta_key', 'duration')->first()?->meta_value ?? null); ?></span>
                        </div>
                    </div>
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                </div>
               <p>
                    <!--[if BLOCK]><![endif]--><?php if($fullDescription): ?>
                        <?php echo $quizAttempt?->quiz?->description; ?>
                ...
                <!--[if BLOCK]><![endif]--><?php if(!empty(setting('_quiz.quiz_instructions'))): ?>
                    <div class="am-instructions">
                        <h6>
                            <i class="am-icon-exclamation-01"></i>
                            <?php echo e(__('quiz::quiz.quiz_instructions')); ?>

                        </h6>
                        <ul>
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = setting('_quiz.quiz_instructions'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $instrcustions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li>
                                    <p><?php echo e($instrcustions['instruction']); ?></p>
                                </li>     
            ...
            <div class="modal-content">
                <div class="am-modal-body">
                    ...
                    <div class="am-deletepopup_title">
                        <h3><?php echo e(__('quiz::quiz.start_quiz_alert_heading')); ?></h3>
                        <p><?php echo e(__('quiz::quiz.start_quiz_alert_para')); ?></p>
                    </div>
                    <div class="am-deletepopup_btns">
                        ...
                        <a href="javascript:void(0);" wire:click="startQuiz" class="am-btn am-btn-success am-confirm-yes"><?php echo e(__('quiz::quiz.start_quiz')); ?></a>
                    </div>
                </div>
            </div>
        </div>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/clientagaintheme/lla.client.againtheme.com/Modules/Quiz/resources/views/livewire/student/quiz-details/quiz-details.blade.php ENDPATH**/ ?>