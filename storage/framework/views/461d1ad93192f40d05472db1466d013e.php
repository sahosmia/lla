...
<li class="<?php echo e(!$menu->children->isEmpty() ? 'page-item-has-children' : ''); ?> <?php echo e(request()->url() == $menu->route && $menu->children->isEmpty() ? 'active' : ''); ?>">
    <a href="<?php echo e(!$menu->children->isEmpty() ? 'javascript:;' : (!empty($menu->route) ? url($menu->route) : url('/'))); ?>"
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if( !$menu->children->isEmpty() ): ?>
...
<?php endif; ?>
    ...
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</li><?php /**PATH C:\Users\User\Desktop\well-known\resources\views/components/menu-item.blade.php ENDPATH**/ ?>