    ...
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="workreap-aicontent-profile_content-72ModalLabel">
            <img src="<?php echo e(asset('images/ai-icon.svg')); ?>" alt="OpenAI">
        ...
        <div class="am-aichat">
          <ul class="am-aichat_list">
            <li class="am-ai_empty">
              ...
              <p><?php echo e(__('general.write_with_ai')); ?></p>
            </li>
          </ul>
          <div class="am-aichat_input">
            <input type="text" placeholder="<?php echo e(__('general.ai_input_placeholder')); ?>" class="form-control" id="ai-user-input">
...
jQuery(document).ready(function() {
    ...
    let aiLoaderTemplate = `<li class="am-ai_loader"><div class="am-ai-reply">
                <figure class="am-ai-reply_avatar">
                    <img src="<?php echo e(asset('images/ai-icon.svg')); ?>" alt="AI Response">
                </figure>
    ...
    jQuery(document).on('click', '.am-aibtn_request', function() {
      ...
      var input = jQuery('#ai-user-input').val();
        $.ajax({
            url: '<?php echo e(route("openai.submit")); ?>',
            type: 'POST',
            data: {
            ...
            error: function(xhr) {
                showAlert({
                  message: xhr.responseJSON?.message ?? '<?php echo e(__("general.something_went_wrong")); ?>',
                  type: 'error'
                });
                resetAiModal();
            }
    ...
    jQuery(document).delegate('.am-ai_copy', 'click', function() {
      ...
      navigator.clipboard.writeText(responseText.trim()).then(function() {
        _this.html('<i class="am-icon-copy-01" aria-hidden="true"></i><?php echo e(__("general.copied")); ?>');
        setTimeout(function() {
          _this.html('<i class="am-icon-copy-01" aria-hidden="true"></i><?php echo e(__("general.copy")); ?>');
        }, 1000);
      });
    });
      ...
      let aiResponseTemplate = `<li class="am-user-reply am-ai-reply_ai_reply">
              <div class="am-ai-reply">
                ...
                <div class="am-ai-reply_tags">
                  <a href="javascript:;" class="am-btn am-ai_replace"><i class="am-icon-arrow-up" aria-hidden="true"></i><?php echo e(__('general.replace')); ?></a>
                  <a href="javascript:;" class="am-btn am-ai_insert"><i class="am-icon-arrow-bottom-left" aria-hidden="true"></i><?php echo e(__('general.insert')); ?></a>
                  <a href="javascript:;" class="am-btn am-ai_copy"><i class="am-icon-copy-01" aria-hidden="true"></i><?php echo e(__('general.copy')); ?></a>
                  <a href="javascript:;" class="am-btn am-ai_regenerate"><?php echo e(__('general.regenerate')); ?></a>
                </div>
              </div>
            </li>`;
    ...
    function appendUserQuery(input) {
      let userQueryTemplate = `<li class="am-user-reply am-ai-reply_ai-user_reply">
                <div class="am-ai-reply">   
                    <figure class="am-ai-reply_avatar">
                      <img src="<?php echo e($userImage); ?>" alt="User Image">
                    </figure>
...
</script><?php /**PATH /home/clientagaintheme/lla.client.againtheme.com/resources/views/components/open_ai.blade.php ENDPATH**/ ?>