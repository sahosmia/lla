                    ...
                    <aside class="op-fields-aside">
                        <ul class="op-feildlisting nav nav-tabs" role="tablist" role="presentation">
                            <?php
                             ...
                             ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $single): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                    $id          = $single['id'].'-tab';
                                    $active_class = '';
                                    if( !empty($active_tab) ){
                                ...
                                <div class="tab-pane fade <?php echo e(!empty($active_class)  ? 'show active' : ''); ?>" id="<?php echo e($single['id']); ?>" role="tabpanel" aria-labelledby="<?php echo e($single['id']); ?>-tab">
                                   <div class="op-tabswrapp">
                                       ...
                                       <form id="<?php echo e($single['id']); ?>-form" class="op-themeform op-fieldform" method="post">
                                           ...
                                           <fieldset>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($single['tabs'])): ?>
                                                    <ul class="op-feildlisting op-feildlistingvtwo nav nav-tabs" role="tablist" role="presentation">
                                                        <?php $tabCount=1; ?>
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $single['fields']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fTab=>$fields): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <li>
...
<?php $__env->startPush(config('optionbuilder.style_var')); ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if( config('optionbuilder.add_bootstrap') === 'yes' ): ?>
        <link rel="stylesheet" href="<?php echo e(asset('vendor/optionbuilder/css/bootstrap.min.css')); ?>">
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if( config('optionbuilder.add_select2') === 'yes' ): ?>
...
<?php $__env->startPush(config('optionbuilder.script_var')); ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if( config('optionbuilder.add_jquery') === 'yes' ): ?>
...
<?php echo $__env->make(config('optionbuilder.layout'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Desktop\well-known\vendor\larabuild\optionbuilder\src/../resources/views/index.blade.php ENDPATH**/ ?>