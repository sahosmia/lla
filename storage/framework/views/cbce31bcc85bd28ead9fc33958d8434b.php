 ...
 <div class="cr-course-box" wire:init="loadData">
    <div class="cr-titlewrap">
        <div class="cr-content-box">
            <h2><?php echo e(__('courses::courses.faqs')); ?></h2>
            <p><?php echo e(__('courses::courses.faqs_description')); ?>:</p>
        </div>
        <!--[if BLOCK]><![endif]--><?php if(!$faqs->isEmpty()): ?>
            <span wire:click="addMoreFaq" wire:loading.class="am-btn_disable" wire:target="addMoreFaq"><?php echo e(__('courses::courses.plus_add_more')); ?></span>
    ...
    <!--[if BLOCK]><![endif]--><?php if($faqs->isEmpty()): ?>
        <div class="cr-no-record-container">
            ...
            <button type="button" wire:click="addMoreFaq" class="am-btn" wire:loading.class="am-btn_disable" wire:target="addMoreFaq">
                <?php echo e(__('courses::courses.create_faq')); ?>
            ...
            <div class="accordion">
                ...
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="accordion-item">
                        <input type="radio" name="accordion" id="faq-<?php echo e($faq->id); ?>" class="accordion-checkbox">
                        <label for="faq-<?php echo e($faq->id); ?>" class="accordion-header">
                            ...
                            <div class="am-itemdropdown">
                                ...
                                <ul class="am-itemdropdown_list dropdown-menu" aria-labelledby="dropdownMenuLink">
                                    <li>
                                        <a href="javascript:void(0);" wire:click="editFaq(<?php echo e($faq); ?>)">
                                            <i>
                                    ...
                                    <li>
                                        <a href="javascript:void(0);" class="cr-delete-option" @click="$wire.dispatch('showConfirm', { id : <?php echo e($faq->id); ?>, action : 'delete-faq' })">
                                            <i>
                                                <svg  width="20" height="20" viewBox="0 0 20 20" fill="none">
                                            ...
                                            <?php echo e(__('courses::courses.delete_faq')); ?>
    ...
    <div class="cr-pre-requisites">
        <div class="cr-content-box">
            <h2><?php echo e(__('courses::courses.prerequisites_title')); ?></h2>
            <p><?php echo e(__('courses::courses.prerequisites_description')); ?></p>
        </div>
        <form class="am-themeform">
            <fieldset>
                <div class="am-themeform__wCoursesrap">
                    <div class="form-group-wrap">
                        <div class="form-group <?php $__errorArgs = ['prerequisites'];
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['fieldName' => 'prerequisites']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['field_name' => 'prerequisites']); ?>
...
<?php endif; ?>
    ...
    <div class="am-themeform_footer">
        <a href="<?php echo e(route('courses.tutor.edit-course', ['tab' => 'content', 'id' => $courseId])); ?>" class="am-white-btn">
            <svg  width="18" height="18" viewBox="0 0 18 18" fill="none">
        ...
        <button type="button" wire:click.prevent='save' class="am-btn" wire:loading.attr="disabled" wire:target="save" wire:loading.class="am-btn_disable"><?php echo e(__('courses::courses.save_continue')); ?></button>
        ...
        <div class="modal-dialog modal-dialog-centered ">
            ...
            <div class="modal-header">
                <!--[if BLOCK]><![endif]--><?php if($updateMode): ?>
                    <h5 class="modal-title" id="create-faqLabel"><?php echo e(__('courses::courses.update_faq')); ?></h5>
                <?php else: ?>
                    <h5 class="modal-title" id="create-faqLabel"><?php echo e(__('courses::courses.add_faq')); ?></h5>
                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                <span class="cr-close" data-bs-dismiss="modal" aria-label="<?php echo e(__('courses::courses.close')); ?>">
            ...
            <form class="am-themeform">
                <fieldset>
                    <div class="am-themeform__wrap">
                        <div class="form-group <?php $__errorArgs = ['question'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> cr-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                            <label class="am-important" for="course-title"><?php echo e(__('courses::courses.question')); ?></label>
                            <?php if (isset($component)) { $__componentOriginal18c21970322f9e5c938bc954620c12bb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal18c21970322f9e5c938bc954620c12bb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['wire:model' => 'question','id' => 'course-title','placeholder' => ''.e(__('courses::courses.enter_question')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'question','id' => 'course-title','placeholder' => ''.e(__('courses::courses.enter_question')).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                            <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['fieldName' => 'question']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-error'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['field_name' => 'question']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalf94ed9c5393ef72725d159fe01139746)): ?>
<?php $attributes = $__attributesOriginalf94ed9c5393ef72725d159fe01139746; ?>
...
<?php endif; ?>
                        ...
                        <div class="form-group <?php $__errorArgs = ['answer'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> cr-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                            <label class="am-important" for="answer"><?php echo e(__('courses::courses.answer')); ?></label>
                            <div class="am-editor-wrapper">
                                <div class="am-custom-editor am-custom-textarea" wire:ignore>
                            ...
                            <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['fieldName' => 'answer']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-error'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['field_name' => 'answer']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalf94ed9c5393ef72725d159fe01139746)): ?>
<?php $attributes = $__attributesOriginalf94ed9c5393ef72725d159fe01139746; ?>
...
<?php endif; ?>
            ...
            <div class="modal-footer">
                ...
                <button type="button" wire:click='addFaq' wire:loading.class="am-btn_disable" wire:target="addFaq" class="am-btn"><?php echo e(__('courses::courses.save_changes')); ?></button>
            </div>
            </div>
        </div>
    </div>
 ...
 <script type="text/javascript">
    ...
    document.addEventListener('livewire:initialized', function() {
        $(document).on('summernote.change', '#answer', function(we, contents, $editable) {
            window.Livewire.find('<?php echo e($_instance->getId()); ?>').set("answer",contents, false);
        });

        $(document).on('summernote.change', '#prerequisites', function(we, contents, $editable) {
            window.Livewire.find('<?php echo e($_instance->getId()); ?>').set("prerequisites",contents, false);
        });
    });
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/clientagaintheme/lla.client.againtheme.com/Modules/Courses/resources/views/livewire/tutor/course-creation/components/course-faqs.blade.php ENDPATH**/ ?>