                                    ...
                                    <tr>
                                            ...
                                            <div class="tb-varification_userinfo">
                                                <a href="javascript:void(0);" class="identity-image" data-image="<?php echo e(Storage::url($single?->personal_photo) ?? ''); ?>">
                                                    <strong class="tb-adminhead__img">
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($single?->personal_photo) && Storage::disk(getStorageDisk())->exists($single?->personal_photo)): ?>
                                        ...
                                        <td data-label="<?php echo e(__('identity.identity_document' )); ?>">
                                            <a href="javascript:void(0);" class="identity-image" data-type="attachment" data-image="<?php echo e($single?->attachments ? Storage::url($single->attachments) : ''); ?>">
                                                <strong class="tb-adminhead__img">
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($single?->attachments) && Storage::disk(getStorageDisk())->exists($single?->attachments)): ?>
                                            ...
                                            <div class="am-resume_item_title">
                                                <div class="am-itemdropdown">
                                                    ...
                                                    <ul class="am-itemdropdown_list dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($single?->status != 'accepted'): ?>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\Users\User\Desktop\well-known\resources\views/livewire/pages/admin/identity-verification/identitiy_verification.blade.php ENDPATH**/ ?>