        ...
        <div class="col-lg-12 col-md-12">
            ...
            <div class="am-disputelist_wrap">
                <div class="am-disputelist am-custom-scrollbar-y">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if( !$allTutorReviews->isEmpty() ): ?>
                    <table class="tb-table <?php if(setting('_general.table_responsive') == 'yes'): ?> tb-table-responsive <?php endif; ?>">
                        ...
                        <tbody>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $allTutorReviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $single): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td data-label="<?php echo e(__('general.tutor')); ?>">
                                    <div class="tb-varification_userinfo">
                                        <strong class="tb-adminhead__img">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($single?->tutor?->profile?->image) && Storage::disk(getStorageDisk())->exists($single?->tutor?->profile?->image)): ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($single?->ratingable_type == 'Modules\Courses\Models\Course'): ?>
                                    <td data-label="<?php echo e(__('general.reviewed_on')); ?>">
                                        <div class="tb-varification_userinfo">
                                            <strong class="tb-adminhead__img">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($single?->ratingable?->media?->path) && Storage::disk(getStorageDisk())->exists($single?->ratingable?->media?->path)): ?>
                                ...
                                <?php else: ?>
                                    <td data-label="<?php echo e(__('general.reviewed_on')); ?>">
                                        <div class="tb-varification_userinfo">
                                            <strong class="tb-adminhead__img">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($single?->ratingable?->slot?->subjectGroupSubjects?->image) && Storage::disk(getStorageDisk())->exists($single?->ratingable?->slot?->subjectGroupSubjects?->image)): ?>
...
<?php /**PATH C:\Users\User\Desktop\well-known\resources\views/livewire/pages/admin/reviews/reviews.blade.php ENDPATH**/ ?>