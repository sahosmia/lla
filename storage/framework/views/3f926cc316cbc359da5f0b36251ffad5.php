    ...
    <nav class="am-navigation">
        <ul>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $menuItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($role, $item['accessibility'])): ?>
                    ...
                    <figure class="am-setup_img">
                        ...
                        <figcaption class="am-setup_img_content">
                            ...
                            <figure class="am-setup_img_icon">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($userPayoutMethod?->payout_method == 'paypal'): ?>
...
<?php /**PATH C:\Users\User\Desktop\well-known\resources\views/livewire/pages/common/navigation.blade.php ENDPATH**/ ?>