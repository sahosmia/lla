            ...
            <div class="am-dbbox">
                ...
                <div class="am-dbbox_content">
                    <div x-data="{current_method:<?php if ((object) ('form.current_method') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('form.current_method'->value()); ?>')<?php echo e('form.current_method'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('form.current_method'); ?>')<?php endif; ?>}" class="am-payout_wrap">
                        ...
                        ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $payout_method; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div wire:key=$method.'-'.time()}}" class="am-payout_item">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item['price']): ?>
                            ...
                            <div class="am-radio">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$item['price'] > 0): ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\User\Desktop\well-known\resources\views/livewire/pages/tutor/manage-account/manage-account.blade.php ENDPATH**/ ?>