<ul class="am-userperinfo_tab">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->role == 'tutor' || $isIdentity == 'both'): ?>
    ...
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</ul><?php /**PATH C:\Users\User\Desktop\well-known\resources\views/livewire/pages/common/profile-settings/tabs.blade.php ENDPATH**/ ?>