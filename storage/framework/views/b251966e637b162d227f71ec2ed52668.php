                                    ...
                                    <div class="form-group tb-actionselect">
                                        <div class="lb-select">
                                            <select class="form-control" id="filter_per_page">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $per_page_opt; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>{
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make(config('pagebuilder.layout'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Desktop\well-known\vendor\larabuild\pagebuilder\src/../resources/views/pages.blade.php ENDPATH**/ ?>