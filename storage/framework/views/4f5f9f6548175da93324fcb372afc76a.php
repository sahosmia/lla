<div class="cr-all-courses" wire:init="loadData">
    <div class="cr-page-heading">
        <div class="cr-headingbox">
            <h2><?php echo e(__('courses::courses.all_courses')); ?></h2>
            <p><?php echo e(__('courses::courses.explore_courses')); ?></p>
        </div>
        <a class="am-btn cr-btn" href="<?php echo e(route('courses.tutor.create-course')); ?>">
            <?php echo e(__('courses::courses.create_course')); ?>
    ...
    <div class="cr-stats-arae">
        <div class="cr-stat-card">
            <div class="cr-contentbox">
                <span><?php echo e($counts['active']); ?></span>
                <p><?php echo e(__('courses::courses.active_courses')); ?></p>
            </div>
        ...
        <div class="cr-stat-card">
            <div class="cr-contentbox">
                <span><?php echo e($counts['draft']); ?></span>
                <p><?php echo e(__('courses::courses.draft_courses')); ?></p>
            </div>
        ...
        <div class="cr-stat-card">
            <div class="cr-contentbox">
                <span><?php echo e($counts['inactive']); ?></span>
                <p><?php echo e(__('courses::courses.inactive_courses')); ?></p>
            </div>
        ...
        <div class="cr-stat-card">
            <div class="cr-contentbox">
                <span><?php echo e($counts['under_review']); ?></span>
                <p><?php echo e(__('courses::courses.under_review')); ?></p>
            </div>
        ...
        <div class="cr-stat-card">
            <div class="cr-contentbox">
                <span><?php echo e($counts['need_revision']); ?></span>
                <p><?php echo e(__('courses::courses.needs_revision')); ?></p>
            </div>
    ...
    <div class="cr-filter-area">
        <div class="at-form-group">
            <input type="text" class="at-form-control" placeholder="<?php echo e(__('courses::courses.search_by_keyword')); ?>" wire:model.live.debounce.500ms='filters.keyword'>
        ...
        <div class="cr-filters">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showClearFilters): ?>
                <span class="cr-clear-filter" wire:click="resetFilters"><?php echo e(__('courses::courses.clear_all_filters')); ?>
            ...
            <div class="at-form-group" wire:ignore>
                <select class="am-select2" data-componentid="window.Livewire.find('<?php echo e($_instance->getId()); ?>')" id="sort-select" data-live="true" data-searchable="false" data-wiremodel="filters.sort">
            ...
            <div class="at-form-group" wire:ignore>
                <select class="am-select2"  data-componentid="window.Livewire.find('<?php echo e($_instance->getId()); ?>')" id="category-select" data-live="true" data-searchable="true" data-wiremodel="filters.category_id">
                    <option value=""><?php echo e(__('courses::courses.select_a_category')); ?></option>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($categories)): ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isPaidSystem()): ?>    
                <div class="at-form-group cr-price-dropdown" wire:ignore>
                    <span><?php echo e(__('courses::courses.price_range')); ?>
                    ...
                    <div class="cr-price-range" style="display: none;">
                        <div class="form-group ">
                            <label class="am-important" for="course-title"><?php echo e(__('courses::courses.price_range')); ?></label>
                            <div class="form-group-two-wrap">
                                <input class="form-control" type="number" id="cr_min_price" placeholder="<?php echo e(__('courses::courses.min_price')); ?>">
                                <input class="form-control" type="number" id="cr_max_price" placeholder="<?php echo e(__('courses::courses.max_price')); ?>">
                            </div>
            ...
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <div class="at-form-group" wire:ignore>
                <select class="am-select2"  data-componentid="window.Livewire.find('<?php echo e($_instance->getId()); ?>')" id="status-select" data-live="true" data-searchable="false" data-wiremodel="filters.status">
                    <option value=""><?php echo e(__('courses::courses.select_status')); ?></option>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($statuses)): ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status => $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($status); ?>"><?php echo e(__('courses::courses.'. $status)); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </select>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
    ...
    <div class="am-table-area">
            ...
            <table class="am-table">
                <thead>
                    <tr>
                        ...
                        <th><?php echo e(__('courses::courses.price')); ?></th>
                        <th><?php echo e(__('courses::courses.enrolled_students')); ?></th>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$isLoading): ?>
                    <tbody wire:loading.block>
                        <?php echo $__env->make('courses::skeletons.courses-listing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </tbody>

                    <tbody wire:loading.remove.block>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($courses) && $courses->isNotEmpty()): ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr wire:key="<?php echo e($course->id); ?>">
                                    <td data-label="<?php echo e(__('courses::courses.course_title')); ?>">
                                        <div class="cr-image-and-text">
                                            <figure>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($course->thumbnail?->path)): ?>
                                                    <img src="<?php echo e(url(Storage::url($course->thumbnail?->path))); ?>" alt="<?php echo e($course->title); ?>">
                                                <?php else: ?>
                                                    <img src="<?php echo e(asset('modules/courses/images/course.png')); ?>" alt="<?php echo e($course->title); ?>">
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            </figure>
                                            <?php echo e(html_entity_decode($course->title)); ?>

                                        </div>
                                    </td>
                                    <td data-label="<?php echo e(__('courses::courses.category')); ?>"><?php echo e($course->category?->name); ?></td>
                                    <td data-label="<?php echo e(__('courses::courses.price')); ?>"><?php echo e(isPaidSystem() && !empty($course->pricing?->final_price)? formatAmount($course->pricing?->final_price) : __('courses::courses.free')); ?></td>
                                    <td data-label="<?php echo e(__('courses::courses.enrolled_students')); ?>">
                                        <div class="student-list">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($course->enrollments) && $course->enrollments->isNotEmpty()): ?>
                                                <div class="cr-avatar-group">
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $course->enrollments->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enrollment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($enrollment->student?->image) && Storage::disk(getStorageDisk())->exists($enrollment->student?->image)): ?>
                                                            <img class="cr-avatar" src="<?php echo e(resizedImage($enrollment->student?->image, 26, 26)); ?>" alt="<?php echo e($enrollment->student?->image); ?>" />
                                                        <?php else: ?>
                                                            <img class="cr-avatar" src="<?php echo e(setting('_general.default_avatar_for_user') ? url(Storage::url(setting('_general.default_avatar_for_user')[0]['path'])) : resizedImage('placeholder.png', 50, 50)); ?>" alt="<?php echo e($enrollment->student?->image); ?>" />
                                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                </div>
                                                <span>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($course->enrollments_count == 1): ?>
                                                        <?php echo e(__('courses::courses.total_enrolled_student')); ?>

                                                    <?php else: ?>
                                                        <?php echo e(__('courses::courses.total_enrolled_students', ['count' => $course->enrollments_count])); ?> 
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                </span>
                                            <?php else: ?>
                                                <span>
                                                    <?php echo e(__('courses::courses.no_enrolled_students')); ?>
                                    ...
                                    <td data-label="<?php echo e(__('courses::courses.status')); ?>">
                                        <div class="cr-status-wrap">
                                            <span class="cr-status">
                                                <span style="background-color: <?php echo e($course->status_color ?? '#008000'); ?>;" class="cr-dot active"></span>
                                                <?php echo e(__('courses::courses.' . $course->status)); ?>
                                                ...
                                                <ul class="am-itemdropdown_list dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                    <li>
                                                        <a href="<?php echo e(route('courses.course-detail', ['slug' => $course->slug])); ?>" target="_blank">
                                                            ...
                                                            <?php echo e(__('courses::courses.view_details')); ?>

                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo e(route('courses.course-taking', ['slug' => $course->slug])); ?>" target="_blank">
                                                            <i class="am-icon-book-1"></i>
                                                            <?php echo e(__('courses::courses.course_page')); ?>

                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo e(route('courses.tutor.edit-course', ['tab' => 'details', 'id' => $course->id])); ?>">
                                                    ...
                                                    <li> 
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if( $course->featured): ?>
                                                            <a href="javascript:void(0);" wire:click.prevent="toggleFeatured(<?php echo e($course->id); ?>)">
                                                                <i class="am-icon-heart-filled-1"></i>
                                                                <?php echo e(__('courses::courses.unfeature')); ?>

                                                            </a>
                                                        <?php else: ?>
                                                        <a href="javascript:void(0);" wire:click.prevent="toggleFeatured(<?php echo e($course->id); ?>)">
                                                                <i class="am-icon-heart-02"></i>
                                                                <?php echo e(__('courses::courses.feature')); ?>

                                                            </a>
                                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0);" class="am-del-btn" @click="$wire.dispatch('showConfirm', { id : <?php echo e($course->id); ?>, action : 'delete-course' })">
                                ...
                                <td>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showClearFilters): ?>
                                        <div class="cr-no-record-container">
                                            ...
                                            <h6><?php echo e(__('courses::courses.empty_view_heading')); ?>!</h6>
                                            <p><?php echo e(__('courses::courses.empty_view_description')); ?></p>
                                        </div>
                                    <?php else: ?>
                                        <div class="cr-no-record-container">
                                            <figure>
                                                <img src="<?php echo e(asset('modules/courses/images/empty-view.png')); ?>" alt="<?php echo e(__('courses::courses.empty_view')); ?>">
                                            </figure>
                                            <h6><?php echo e(__('courses::courses.no_records_added_yet')); ?></h6>
                                            <p><?php echo e(__('courses::courses.create_engaging_courses')); ?></p>
                                            <a href="<?php echo e(route('courses.tutor.create-course')); ?>">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$isLoading && $courses->links()->paginator->hasPages()): ?>
            <div class="am-pagination">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($parPageList)): ?>
                    <div class="am-pagination-filter" wire:ignore>
                        <em><?php echo e(__('courses::courses.show')); ?></em>
                        <span class="am-select">
                            <select x-init="$wire.dispatch('initSelect2', {target: '#per-page-select'});" class="am-select2" id="per-page-select" data-componentid="window.Livewire.find('<?php echo e($_instance->getId()); ?>')" data-live="true" data-searchable="false" data-wiremodel="perPage">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($perPage) && !in_array($this->perPage, $this->parPageList)): ?>
                                    <option value="<?php echo e($perPage); ?>"><?php echo e($perPage); ?></option>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = perPageOpt(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option <?php echo e($perPage == $option ? 'selected' : ''); ?> value="<?php echo e($option); ?>"><?php echo e($option); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </select>
                        </span>
                        <em><?php echo e(__('courses::courses.listings_per_page')); ?></em>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php echo e($courses->links('courses::pagination.pagination', ['perPageOptions' => $perPageOptions])); ?>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="cr-delete-content">
                        <h3><?php echo e(__('courses::courses.confirm')); ?>!</h3>
                        <p><?php echo e(__('courses::courses.remove_confirmation')); ?></p>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="am-white-btn" data-bs-dismiss="modal"><?php echo e(__('courses::courses.no')); ?></button>
                    <button type="button" class="am-btn cr-del-btn"><?php echo e(__('courses::courses.yes')); ?></button>
                </div>
            </div>
        </div>
    </div>
...
<script defer src="<?php echo e(asset('modules/courses/js/nouislider.min.js')); ?>"></script>
        ...
        document.addEventListener('DOMContentLoaded', function( ) {
            jQuery(document).ready(function() {
                ...
                $(document).on('change', '#cr_min_price, #cr_max_price', function(event){
                    ...
                    window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('filters.min_price', minValue);
                    window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('filters.max_price', maxValue);
                });
            });
        });
 ...
 <?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\User\Desktop\well-known\Modules/Courses\resources/views/livewire/tutor/course-listing/course-listing.blade.php ENDPATH**/ ?>